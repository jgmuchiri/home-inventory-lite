...
<table class="table table-bordered table-responsive">
    ...
    <th class="alert-success">
        <a href="#" class="new-item label label-danger"><span class="glyphicon glyphicon-new-window"></span> new item </a>
    </th>
    <?php
    $counter =1;
    foreach ($items->result() as $row): ?>
        <tr>
            ...
            <td style="width:250px"><a href="#" class="item-img" id="<?php echo $row->id; ?>"><?php echo $row->item; ?></a></td>
            <td style="width:140px"><a href="?location=<?php echo $row->location; ?>"><?php echo $row->location; ?></a></td>
